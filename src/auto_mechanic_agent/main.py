...
from auto_mechanic_agent.crew import AutoMechanicAgent
...
def train():
    ...
    try:
        AutoMechanicAgent().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
def replay():
    ...
    """
    try:
        AutoMechanicAgent().crew().replay(task_id=sys.argv[1])
